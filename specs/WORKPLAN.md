...
| Date | Résumé |
|------|--------|
| 2026-07-17 (5) | LayoutsView : titre 100 % largeur (retour à la ligne), mode liste ⊞/☰ ; fix renommage inline partout (`useInlineRename` : focus + blur différé + mousedown.prevent sur boutons). |
