...
1. **[Phase 1]** Atome **Plan** (spec 2) — drop canvas des tuiles Track
2. **[Phase 4]** Export PDF (même DOM mm comme source) — techno html→PDF à choisir
3. **[Phase 1]** Atome `hexTile` : finaliser le rendu SVG hexagonal
