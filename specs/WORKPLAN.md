...
- [ ] Textures Track — helpers d'empreinte/matching, rendu des atomes, `trakPath` et éditeur médiathèque
...
1. **[Phase 1/2]** Textures Track : helpers d'empreinte et matching, puis rendu des atomes
