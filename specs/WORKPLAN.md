...
| Date | Résumé |
|------|--------|
| 2026-07-18 (2) | **TSD-025 CSS mm + viewport transform** : design + plan + impl. (helpers `cssMm`, éditeur viewport `translate`/`scale`, atomes `mmCss`, drag/guides/drawing, CardPreview, print `break-inside: avoid`). Purge docs : `.cursorrules` / `CLAUDE.md` / TSD-022 note pipeline ; `useMmScale` screen-only. Plus de chemin rendu carte `mm×zoom→px`. |
